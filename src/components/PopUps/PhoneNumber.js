                      ...
                      {showTermsAndConditins ? (
                        <Box my={1} px={2}>
                          <Typography variant="body2" my={1}>
                            ...
                            messages from {restaurantDetails.name}, including
                            updates, promotional offers, and other marketing
                            materials. You understand that your mobile carrier's
                            message and data rates may apply. You may opt-out of
